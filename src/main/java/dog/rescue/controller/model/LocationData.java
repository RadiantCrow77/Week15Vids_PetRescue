...
@Data
// constructor takes location and converts it into a location DAO vvv
@NoArgsConstructor
public class LocationData {
// fields present in location obj
	...
	public LocationData(Location location) { // constructor for location data
	...
	public LocationData(Long locationId, String businessName, String streetAddress, String city, String state,
			String zip, String phone) { // pass in all of the obj except the dogs obj
	...
	// convert location obj back to a location data obj
